...
<body>
	<nav class="header">
		<span class="header__company-name"><?php echo get_theme_mod('company_name_content') ?></span>
		...
		<div class="section-4__content">
			...
			<div class="col col--left">
				<ul class="section-4__step-list">
					<li style="background-image: url('wp-content/themes/mylandingpage/assets/block-1.jpg')" class="section-4__step-list-item">
					...
					<li style="background-image: url('wp-content/themes/mylandingpage/assets/block-2.jpg')" class="section-4__step-list-item">
					...
					<li style="background-image: url('wp-content/themes/mylandingpage/assets/block-3.jpg')" class="section-4__step-list-item">
	...
	<section class="section-5">
		<div class="section-5__wrapper">
			...
			<div id="s5carousel" class="section-5__carousel">
				<div style="background-image: url('wp-content/themes/mylandingpage/assets/stock-person-1.png')" class="section-5__team-member">
				...
				<div style="background-image: url('wp-content/themes/mylandingpage/assets/stock-person-2.png')" class="section-5__team-member">
					<div class="overlay"></div>
					<div class="nametag">
						<div class="badge badge--primary">
							<span>Jimmy Doe</span>
				...
				<div class="section-5__team-member" style="background-image: url('wp-content/themes/mylandingpage/assets/stock-person-3.png')">
					<div class="overlay"></div>
					<div class="nametag">
						<div class="badge badge--primary">
							<span>Jane Doe</span>
		...
		<div class="section-6__content">
			...
			<div class="section-6__rightside">
				...
				<ul class="section-6__client-thumbnails">
					<li style="background-image: url('wp-content/themes/mylandingpage/assets/stock-person-1.png')" data-index="1" data-quote="Kek." data-name="Mark Zuckerberg, Facebook CEO" class="section-6__client-thumbnail"></li>
					<li data-quote="10/10, would destroy IT again" data-name="Bill Gates, Microsoft" style="background-image: url('wp-content/themes/mylandingpage/assets/stock-person-2.png')" data-index="2" class="section-6__client-thumbnail"></li>
					<li data-name="That indian CEO of Google" data-quote="
								...
								bother?" style="background-image: url('wp-content/themes/mylandingpage/assets/stock-person-3.png')" data-index="3" class="section-6__client-thumbnail"></li>
				</ul>
			</div>
		</div>
	</section>
